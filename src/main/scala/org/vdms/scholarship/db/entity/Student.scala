...
object Student {
  def apply(usernamePar: String,
    ...
    new Student(usernamePar,
      ...
      sourceOfFundPar,
      parentAddressPar,
      parentEducationLevelPar,
      dependentOfParentPar,
      bothParentWorkingPar,
      parentIncomeRangePar,
      parentOccupationPar,
      bankNamePar,
      graduationTargetPar,
      bankAccountNamePar,
      bankAccountNumberPar,
      toeflScorePar,
      alternativePhoneNumberPar)
  }
}